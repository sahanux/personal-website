...
(() => {
  ...
  // Official brand marks are solid shapes, not strokes
  const svgFill = (paths, size = 24) =>
  ...
  const ICON = {
    ...
    // WhatsApp mark: the official glyph (solid handset inside a ring bubble)
    waMark: () =>
      svgFill(
        '<path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.966 1.164-.198.198-.396.223-.693.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.347-.446.52-.669.174-.223.232-.38.347-.62.116-.24.058-.446-.03-.62-.087-.173-.652-1.57-.893-2.145-.213-.51-.43-.516-.618-.523l-.52-.008c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.29.173-1.414-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/>'
      ),
    // LinkedIn mark: the "in" letters, the circle comes from the button itself
    liMark: () =>
      svgFill(
        '<path d="M20.45 20.45h-3.56v-5.57c0-1.33-.02-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.42v1.56h.04c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.46zM5.34 7.43a2.06 2.06 0 1 1 0-4.13 2.06 2.06 0 0 1 0 4.13m1.78 13.02H3.56V9h3.56z"/>'
      ),
  };
  ...
  const floatingContact = () => `
    <div class="fab" role="group" aria-label="Contact shortcuts">
      <a class="fab__btn fab__btn--wa" href="${waHref()}" target="_blank" rel="noopener"
         aria-label="Message me on WhatsApp" title="WhatsApp">${ICON.waMark()}</a>
      <a class="fab__btn fab__btn--li" href="${S.person.linkedinUrl}" target="_blank" rel="noopener"
         aria-label="Connect with me on LinkedIn" title="LinkedIn">${ICON.liMark()}</a>
    </div>`;
